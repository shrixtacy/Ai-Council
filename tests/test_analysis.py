...
class TestAnalysisEngineInitialization:
    ...
    @pytest.mark.asyncio
    async def test_engine_has_intent_patterns(self):
    ...
    @pytest.mark.asyncio
    async def test_engine_has_complexity_indicators(self):
    ...
    @pytest.mark.asyncio
    async def test_engine_has_task_type_patterns(self):
...
class TestIntentAnalysis:
    ...
    @pytest.mark.asyncio
    async def test_question_intent_with_question_mark(self, engine):
        """Test that question mark indicates question intent."""
        result = await engine.analyze_intent("What is the best approach?")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_what(self, engine):
        """Test that 'what' indicates question intent."""
        result = await engine.analyze_intent("what are the benefits of Python")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_how(self, engine):
        """Test that 'how' indicates question intent."""
        result = await engine.analyze_intent("how do I implement this feature")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_why(self, engine):
        """Test that 'why' indicates question intent."""
        result = await engine.analyze_intent("why is this approach better")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_when(self, engine):
        """Test that 'when' indicates question intent."""
        result = await engine.analyze_intent("when should I use this pattern")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_where(self, engine):
        """Test that 'where' indicates question intent."""
        result = await engine.analyze_intent("where is the configuration stored")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_who(self, engine):
        """Test that 'who' indicates question intent."""
        result = await engine.analyze_intent("who designed this architecture")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_which(self, engine):
        """Test that 'which' indicates question intent."""
        result = await engine.analyze_intent("which framework is better")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_question_intent_with_can_you(self, engine):
        """Test that 'can you' indicates question intent."""
        result = await engine.analyze_intent("can you explain this concept")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_instruction_intent_with_create(self, engine):
        """Test that 'create' indicates instruction intent."""
        result = await engine.analyze_intent("create a new database schema")
        assert result == TaskIntent.INSTRUCTION
    
    @pytest.mark.asyncio
    async def test_instruction_intent_with_make(self, engine):
        """Test that 'make' indicates instruction intent."""
        result = await engine.analyze_intent("make a REST API endpoint")
        assert result == TaskIntent.INSTRUCTION
    
    @pytest.mark.asyncio
    async def test_instruction_intent_with_build(self, engine):
        """Test that 'build' indicates instruction intent."""
        result = await engine.analyze_intent("build a user authentication system")
        assert result == TaskIntent.INSTRUCTION
    
    @pytest.mark.asyncio
    async def test_instruction_intent_with_generate(self, engine):
        """Test that 'generate' indicates instruction intent."""
        result = await engine.analyze_intent("generate a report from this data")
        assert result == TaskIntent.INSTRUCTION
    
    @pytest.mark.asyncio
    async def test_instruction_intent_with_write(self, engine):
        """Test that 'write' indicates instruction intent."""
        result = await engine.analyze_intent("write a function to parse JSON")
        assert result == TaskIntent.INSTRUCTION
    
    @pytest.mark.asyncio
    async def test_instruction_intent_with_implement(self, engine):
        """Test that 'implement' indicates instruction intent."""
        result = await engine.analyze_intent("implement the observer pattern")
        assert result == TaskIntent.INSTRUCTION
    
    @pytest.mark.asyncio
    async def test_instruction_intent_with_please(self, engine):
        """Test that 'please' indicates instruction intent."""
        result = await engine.analyze_intent("please format this code properly")
        assert result == TaskIntent.INSTRUCTION
    
    @pytest.mark.asyncio
    async def test_analysis_intent_with_analyze(self, engine):
        """Test that 'analyze' indicates analysis intent."""
        result = await engine.analyze_intent("analyze the performance bottlenecks")
        assert result == TaskIntent.ANALYSIS
    
    @pytest.mark.asyncio
    async def test_analysis_intent_with_evaluate(self, engine):
        """Test that 'evaluate' indicates analysis intent."""
        result = await engine.analyze_intent("evaluate the system architecture")
        assert result == TaskIntent.ANALYSIS
    
    @pytest.mark.asyncio
    async def test_analysis_intent_with_assess(self, engine):
        """Test that 'assess' indicates analysis intent."""
        result = await engine.analyze_intent("assess the security risks")
        assert result == TaskIntent.ANALYSIS
    
    @pytest.mark.asyncio
    async def test_analysis_intent_with_examine(self, engine):
        """Test that 'examine' indicates analysis intent."""
        result = await engine.analyze_intent("examine the code quality")
        assert result == TaskIntent.ANALYSIS
    
    @pytest.mark.asyncio
    async def test_analysis_intent_with_review(self, engine):
        """Test that 'review' indicates analysis intent."""
        result = await engine.analyze_intent("review the pull request changes")
        assert result == TaskIntent.ANALYSIS
    
    @pytest.mark.asyncio
    async def test_analysis_intent_with_compare(self, engine):
        """Test that 'compare' indicates analysis intent."""
        result = await engine.analyze_intent("compare these two implementations")
        assert result == TaskIntent.ANALYSIS
    
    @pytest.mark.asyncio
    async def test_analysis_intent_with_summarize(self, engine):
        """Test that 'summarize' indicates analysis intent."""
        result = await engine.analyze_intent("summarize the key findings")
        assert result == TaskIntent.ANALYSIS
    
    @pytest.mark.asyncio
    async def test_modification_intent_with_modify(self, engine):
        """Test that 'modify' indicates modification intent."""
        result = await engine.analyze_intent("modify the existing configuration")
        assert result == TaskIntent.MODIFICATION
    
    @pytest.mark.asyncio
    async def test_modification_intent_with_change(self, engine):
        """Test that 'change' indicates modification intent."""
        result = await engine.analyze_intent("change the database connection string")
        assert result == TaskIntent.MODIFICATION
    
    @pytest.mark.asyncio
    async def test_modification_intent_with_update(self, engine):
        """Test that 'update' indicates modification intent."""
        result = await engine.analyze_intent("update the API documentation")
        assert result == TaskIntent.MODIFICATION
    
    @pytest.mark.asyncio
    async def test_modification_intent_with_edit(self, engine):
        """Test that 'edit' indicates modification intent."""
        result = await engine.analyze_intent("edit the main function")
        assert result == TaskIntent.MODIFICATION
    
    @pytest.mark.asyncio
    async def test_modification_intent_with_refactor(self, engine):
        """Test that 'refactor' indicates modification intent."""
        result = await engine.analyze_intent("refactor the legacy code")
        assert result == TaskIntent.MODIFICATION
    
    @pytest.mark.asyncio
    async def test_modification_intent_with_optimize(self, engine):
        """Test that 'optimize' indicates modification intent."""
        result = await engine.analyze_intent("optimize the database queries")
        assert result == TaskIntent.MODIFICATION
    
    @pytest.mark.asyncio
    async def test_verification_intent_with_verify(self, engine):
        """Test that 'verify' indicates verification intent."""
        result = await engine.analyze_intent("verify the test results")
        assert result == TaskIntent.VERIFICATION
    
    @pytest.mark.asyncio
    async def test_verification_intent_with_check(self, engine):
        """Test that 'check' indicates verification intent."""
        result = await engine.analyze_intent("check the code for errors")
        assert result == TaskIntent.VERIFICATION
    
    @pytest.mark.asyncio
    async def test_verification_intent_with_validate(self, engine):
        """Test that 'validate' indicates verification intent."""
        result = await engine.analyze_intent("validate the input data")
        assert result == TaskIntent.VERIFICATION
    
    @pytest.mark.asyncio
    async def test_verification_intent_with_test(self, engine):
        """Test that 'test' indicates verification intent."""
        result = await engine.analyze_intent("test the new functionality")
        assert result == TaskIntent.VERIFICATION
    
    @pytest.mark.asyncio
    async def test_verification_intent_with_confirm(self, engine):
        """Test that 'confirm' indicates verification intent."""
        result = await engine.analyze_intent("confirm the deployment was successful")
        assert result == TaskIntent.VERIFICATION
    
    @pytest.mark.asyncio
    async def test_empty_input_returns_question(self, engine):
        """Test that empty input returns question intent."""
        result = await engine.analyze_intent("")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_whitespace_input_returns_question(self, engine):
        """Test that whitespace input returns question intent."""
        result = await engine.analyze_intent("   ")
        assert result == TaskIntent.QUESTION
    
    @pytest.mark.asyncio
    async def test_unclear_input_defaults_to_instruction(self, engine):
        """Test that unclear input defaults to instruction intent."""
        result = await engine.analyze_intent("random text without clear intent")
        assert result == TaskIntent.INSTRUCTION
...
class TestComplexityDetermination:
    ...
    @pytest.mark.asyncio
    async def test_empty_input_returns_trivial(self, engine):
        """Test that empty input returns trivial complexity."""
        result = await engine.determine_complexity("")
        assert result == ComplexityLevel.TRIVIAL
    
    @pytest.mark.asyncio
    async def test_whitespace_input_returns_trivial(self, engine):
        """Test that whitespace input returns trivial complexity."""
        result = await engine.determine_complexity("   ")
        assert result == ComplexityLevel.TRIVIAL
    
    @pytest.mark.asyncio
    async def test_short_text_is_simple_or_trivial(self, engine):
        """Test that short text has low complexity."""
        result = await engine.determine_complexity("fix the bug")
        assert result in [ComplexityLevel.TRIVIAL, ComplexityLevel.SIMPLE]
    
    @pytest.mark.asyncio
    async def test_medium_text_has_moderate_or_higher_complexity(self, engine):
        """Test that medium length text has appropriate complexity."""
        text = " ".join(["word"] * 30)  # 30 words
        result = await engine.determine_complexity(text)
        assert result in [ComplexityLevel.SIMPLE, ComplexityLevel.MODERATE]
    
    @pytest.mark.asyncio
    async def test_long_text_increases_complexity(self, engine):
    ...
    @pytest.mark.asyncio
    async def test_multi_step_indicators_increase_complexity(self, engine):
        """Test that multi-step indicators increase complexity."""
        result = await engine.determine_complexity("First do this and then do that next step")
        assert result in [ComplexityLevel.SIMPLE, ComplexityLevel.MODERATE, ComplexityLevel.COMPLEX]
    
    @pytest.mark.asyncio
    async def test_step_numbering_increases_complexity(self, engine):
        """Test that numbered steps increase complexity."""
        result = await engine.determine_complexity("step 1: initialize, step 2: process, step 3: finalize")
        assert result in [ComplexityLevel.SIMPLE, ComplexityLevel.MODERATE, ComplexityLevel.COMPLEX]
    
    @pytest.mark.asyncio
    async def test_technical_patterns_increase_complexity(self, engine):
        """Test that technical patterns increase complexity."""
        result = await engine.determine_complexity("implement an advanced algorithm for optimization")
        assert result in [ComplexityLevel.SIMPLE, ComplexityLevel.MODERATE, ComplexityLevel.COMPLEX]
    
    @pytest.mark.asyncio
    async def test_conditional_logic_increases_complexity(self, engine):
        """Test that conditional logic increases complexity."""
        result = await engine.determine_complexity("if this condition then perform that action")
        assert result in [ComplexityLevel.SIMPLE, ComplexityLevel.MODERATE, ComplexityLevel.COMPLEX]
    
    @pytest.mark.asyncio
    async def test_architecture_keyword_increases_complexity(self, engine):
        """Test that 'architecture' keyword increases complexity."""
        result = await engine.determine_complexity("design the system architecture for the new platform")
        assert result in [ComplexityLevel.SIMPLE, ComplexityLevel.MODERATE, ComplexityLevel.COMPLEX]
    
    @pytest.mark.asyncio
    async def test_comprehensive_keyword_increases_complexity(self, engine):
        """Test that 'comprehensive' keyword increases complexity."""
        result = await engine.determine_complexity("create a comprehensive solution")
        assert result in [ComplexityLevel.SIMPLE, ComplexityLevel.MODERATE, ComplexityLevel.COMPLEX]
...
class TestTaskTypeClassification:
    ...
    @pytest.mark.asyncio
    async def test_empty_input_returns_empty_list(self, engine):
        """Test that empty input returns empty list."""
        result = await engine.classify_task_type("")
        assert result == []
    
    @pytest.mark.asyncio
    async def test_whitespace_input_returns_empty_list(self, engine):
        """Test that whitespace input returns empty list."""
        result = await engine.classify_task_type("   ")
        assert result == []
    
    @pytest.mark.asyncio
    async def test_reasoning_classification(self, engine):
        """Test that reasoning keywords are classified correctly."""
        result = await engine.classify_task_type("think about this problem and explain the solution")
        assert TaskType.REASONING in result
    
    @pytest.mark.asyncio
    async def test_research_classification(self, engine):
        """Test that research keywords are classified correctly."""
        result = await engine.classify_task_type("research the best practices for API design")
        assert TaskType.RESEARCH in result
    
    @pytest.mark.asyncio
    async def test_code_generation_classification(self, engine):
        """Test that code generation keywords are classified correctly."""
        result = await engine.classify_task_type("write code for a Python function")
        assert TaskType.CODE_GENERATION in result
    
    @pytest.mark.asyncio
    async def test_debugging_classification(self, engine):
        """Test that debugging keywords are classified correctly."""
        result = await engine.classify_task_type("debug this error in the program")
        assert TaskType.DEBUGGING in result
    
    @pytest.mark.asyncio
    async def test_creative_output_classification(self, engine):
        """Test that creative output keywords are classified correctly."""
        result = await engine.classify_task_type("write a creative story about technology")
        assert TaskType.CREATIVE_OUTPUT in result
    
    @pytest.mark.asyncio
    async def test_image_generation_classification(self, engine):
        """Test that image generation keywords are classified correctly."""
        result = await engine.classify_task_type("generate an image of a mountain landscape")
        assert TaskType.IMAGE_GENERATION in result
    
    @pytest.mark.asyncio
    async def test_fact_checking_classification(self, engine):
        """Test that fact checking keywords are classified correctly."""
        result = await engine.classify_task_type("fact check this claim and verify accuracy")
        assert TaskType.FACT_CHECKING in result
    
    @pytest.mark.asyncio
    async def test_verification_classification(self, engine):
        """Test that verification keywords are classified correctly."""
        result = await engine.classify_task_type("validate this data and confirm the results")
    ...
    async def test_multiple_task_types(self, engine):
        ...
        result = await engine.classify_task_type("research and write code for a debug tool")
        assert len(result) >= 2
    
    @pytest.mark.asyncio
    async def test_default_to_reasoning(self, engine):
        """Test that unclear input defaults to reasoning."""
        result = await engine.classify_task_type("do something with this data")
        assert TaskType.REASONING in result
...
class TestTaskDecomposerInitialization:
    ...
    @pytest.mark.asyncio
    async def test_decomposer_creation(self):
        """Test that the task decomposer can be created."""
        decomposer = BasicTaskDecomposer()
        assert decomposer is not None
    
    @pytest.mark.asyncio
    async def test_decomposer_has_decomposition_patterns(self):
    ...
    @pytest.mark.asyncio
    async def test_decomposer_has_priority_indicators(self):
    ...
    @pytest.mark.asyncio
    async def test_decomposer_has_risk_indicators(self):
...
class TestTaskDecomposition:
    ...
    @pytest.mark.asyncio
    async def test_minimal_task_returns_subtasks(self, decomposer):
        ...
        result = await decomposer.decompose(Task(content="x", complexity=ComplexityLevel.TRIVIAL))
        assert len(result) >= 1  # At least one subtask
    
    @pytest.mark.asyncio
    async def test_simple_task_returns_single_subtask(self, decomposer, simple_task):
    ...
    @pytest.mark.asyncio
    async def test_subtasks_have_parent_task_id(self, decomposer, simple_task):
    ...
    @pytest.mark.asyncio
    async def test_subtasks_have_task_type(self, decomposer, simple_task):
    ...
    @pytest.mark.asyncio
    async def test_decompose_by_explicit_steps(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_decompose_by_sequence_words(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_decompose_by_conjunctions(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_trivial_task_returns_single_subtask(self, decomposer):
...
class TestMetadataAssignment:
    ...
    @pytest.mark.asyncio
    async def test_assign_metadata_sets_priority(self, decomposer):
        ...
        result = await decomposer.assign_metadata(subtask)
        assert result.priority is not None
    
    @pytest.mark.asyncio
    async def test_assign_metadata_sets_risk_level(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_assign_metadata_sets_accuracy_requirement(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_urgent_content_gets_high_priority(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_optional_content_gets_low_priority(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_production_content_gets_high_risk(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_test_content_gets_medium_risk(self, decomposer):
...
class TestDecompositionValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_empty_list_returns_false(self, decomposer):
        """Test that empty subtask list is invalid."""
        result = await decomposer.validate_decomposition([])
        assert result is False
    
    @pytest.mark.asyncio
    async def test_validate_valid_subtasks_returns_true(self, decomposer):
        ...
        result = await decomposer.validate_decomposition(subtasks)
        assert result is True
    
    @pytest.mark.asyncio
    async def test_validate_different_parent_ids_returns_false(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_validate_subtask_with_none_task_type_returns_false(self, decomposer):
...
class TestAccuracyRequirementDetermination:
    ...
    @pytest.mark.asyncio
    async def test_fact_checking_has_high_accuracy(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_verification_has_high_accuracy(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_code_generation_has_moderate_accuracy(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_creative_output_has_lower_accuracy(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_high_risk_increases_accuracy(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_accuracy_never_exceeds_one(self, decomposer):
...
class TestCostEstimation:
    ...
    @pytest.mark.asyncio
    async def test_image_generation_has_highest_base_cost(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_longer_content_increases_cost(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_higher_accuracy_increases_cost(self, decomposer):
    ...
    @pytest.mark.asyncio
    async def test_cost_is_non_negative(self, decomposer):
